...
- Fix headless Tabs not using the same NavigationContext as the other navigators. ([#32114](https://github.com/expo/expo/pull/32114) by [@marklawlor](https://github.com/marklawlor))
